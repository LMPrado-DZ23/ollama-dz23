...
import { BoltIcon, Cog6ToothIcon, RectangleGroupIcon } from "@heroicons/react/24/outline";

type AppSection = "apps" | "chat" | "agentic" | "settings";
...
export function AppNavigation({ current }: { current: AppSection }) {
  ...
  return (
    <div className="flex flex-col gap-0.5">
      ...
      <Link to="/agentic" className={itemClass("agentic")} draggable={false}>
        <BoltIcon className="h-5 w-5 stroke-current" />
